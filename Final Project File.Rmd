...
```{r}
## loading 2018 data
state_carbon_emission <- read.csv("C:/Users/13015/OneDrive - Emory University/Documents/Emory/Fall_23/ENGRD 302W/Final Project/Data/state_carbon_emission.csv")
head(state_carbon_emission)

state_df <- map_data("state")

## subsetting data
state_population_2018 <- read.csv("C:/Users/13015/OneDrive - Emory University/Documents/Emory/Fall_23/ENGRD 302W/Final Project/Data/2018_state_population.csv")

state_asthma_2018 <- read.csv("C:/Users/13015/OneDrive - Emory University/Documents/Emory/Fall_23/ENGRD 302W/Final Project/Data/2018_asthma_state_data.csv")

state_tax_2018 <- read.csv("C:/Users/13015/OneDrive - Emory University/Documents/Emory/Fall_23/ENGRD 302W/Final Project/Data/2018_state_emission_tax_data.csv")
```
...
pct_emission_change_map <- ggplot(state_final_df_2018, aes(x=long, y=lat)) +
  ...
  labs(fill = "Change in Carbon Emission 2018-19") +
  theme(plot.margin = margin(0.5, 0.5, 0.5, 0.5, "cm"),
        legend.title = element_text(size = 8),
        legend.key.size = unit(0.5, "cm")) +
  theme(plot.background = element_rect(fill = "white"))

pct_emission_change_map

ggsave("pct_emission_change_map.png", pct_emission_change_map)
...
emission_map_2018 <- ggplot(state_final_df_2018, aes(x=long, y=lat)) +
        ...
        geom_polygon(data = state_map_data, aes(group=group), color = "black", fill = NA) + 
        theme_void() + coord_quickmap() +
  labs(fill = "2018 Carbon Emissions (metric ton)") +
  theme(plot.margin = margin(0.5, 0.5, 0.5, 0.5, "cm"),
        legend.title = element_text(size = 8),
        legend.key.size = unit(0.5, "cm")) +
  theme(plot.background = element_rect(fill = "white"))
...
ggsave("emission_map_2018.png", emission_map_2018)

## raw asthma diagnosis 2018
asthma_population_2018_map <- ggplot(state_final_df_2018, aes(x=long, y=lat)) +
        ...
        geom_polygon(data = state_map_data, aes(group=group), color = "black", fill = NA) + 
        theme_void() + coord_quickmap() +
  labs(fill = "Count Asthma Diagnosis 2018") +
  theme(plot.margin = margin(0.5, 0.5, 0.5, 0.5, "cm"),
        legend.title = element_text(size = 8),
        legend.key.size = unit(0.5, "cm")) +
  theme(plot.background = element_rect(fill = "white"))

asthma_population_2018_map

ggsave("asthma_population_2018_map.png", asthma_population_2018_map)
...
pct_asthma_2018_map <- ggplot(state_final_df_2018, aes(x=long, y=lat)) +
        ...
        geom_polygon(data = state_map_data, aes(group=group), color = "black", fill = NA) + 
        theme_void()+ coord_quickmap() +
  labs(fill = "Percent Total Population Asthma Diagnosis 2018") +
  theme(plot.margin = margin(0.5, 0.5, 0.5, 0.5, "cm"),
        legend.title = element_text(size = 8),
        legend.key.size = unit(0.5, "cm")) +
  theme(plot.background = element_rect(fill = "white"))
...
ggsave("pct_asthma_2018_map.png", pct_asthma_2018_map)
```

## Creating Asthma Summary
...
ggsave("asthma_bar_2018.png", asthma_bar_2018, height = 8)
```
...
ggsave("state_tax_bar_2018.png", state_tax_bar_2018, height = 8)

```

## Creating Emission Summary
...
## Emission Data per Capita Visualization

```{r}
## emission per capital horizontal bar graph
state_emission_2018_plot <- ggplot(state_emission_2018, aes(y=fct_reorder(state, emission_per_capita) %>% fct_rev(), x=emission_per_capita, fill = state))+
  ...
  theme(legend.position = "none",
        plot.margin = margin(0.5, 0.5, 0.5, 0.5, "cm")) +
  labs(title = "Carbon Emission (metric ton) per Capita",
       x = "Carbon Emission (metric ton)",
       y = "State")

state_emission_2018_plot

ggsave("state_emission_2018_plot.png", state_emission_2018_plot, height = 8)
